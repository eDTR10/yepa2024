  ...
  return (
    ...
    <div className="relative h-[100vh]  w-full max-w-5xl mx-auto overflow-hidden">
      ...
      <div className="  z-50  relative gap-2 w-full h-full flex-col flex items-center  justify-center">
        <h1 className=' text-[60px] font-harlow text-[#ca5a4c] md:text-lg '>My Mr. and Ms. Best Dressed</h1>
            ...
            >
              ...
              >
                <CardContent className="p-4 flex flex-col items-center justify-between h-full text-white">
                    <div className=' pointer-events-none relative flex w-full h-[100%] overflow-hidden'>
                        <img 
                  ...
                  <h3 className=" bg-white px-1 py-2 shadow-sm absolute bottom-0 text-md font-harlow text-[#ca5a4c] capitalize">{ capitalizeFirst(product.title )}</h3>
                    </div>
